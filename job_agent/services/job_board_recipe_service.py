...
def _enrich_jobs_with_detail_api_with_trace(
    ...
    *,
    ...
    for index, job in enumerate(target_jobs):
        ...
        detail_record = _json_path(payload, recipe.detail_api.results_path) if recipe.detail_api.results_path else payload
...
def _api_request_for_page(api, page_index: int) -> dict[str, Any]:
    ...
    page_size = pagination.page_size or _int_from_mapping(body, pagination.page_size_param) or _int_from_mapping(
        params, pagination.page_size_param
    )
